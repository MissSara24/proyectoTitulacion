                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><input type="text" name="carrera" value="<?= $row['carrera']?>"></td>
                                    <td><input type="text" name="profesor" value="<?= $row['profesor']?>"></td> 
                                    <td><input type="hidden" name="categoria" value="<?= $row['categoria']?>"></td> 
                                    <td><input type="hidden" name="tipo" value="<?= $row['tipo']?>"></td> 
                                </tr>
                            </tbody>
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                <tr>
                                    <td><input type="file" name="archivo" style="width:140px;"></td>
