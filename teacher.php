			...
			<table class="table table-striped table-hover">
                ...
                <?php while ($row = mysqli_fetch_array($query)): ?>
					<tr>
						...
						<td>
                            <a href="#ViewProject" class="view" title="View" data-toggle="modal"><i class="material-icons">&#xE417;</i></a>
		...
		<div class="modal-content">
			<form action="edit_project.php" method="POST">
				...
				<div class="modal-body">					
					...
					<div class="form-group">
						<label>Unidad de Aprendizaje</label>
						<input type="text" name="id_materia"  class="form-control" value="<?= $row['id_materia']?>" required>
					</div>
					<div class="form-group">
						<label>Carrera</label>
						<input type="text" name="id_carrera" class="form-control" value="<?= $row['id_carrera']?>"required>
					</div>
					<div class="form-group">
						<label>Profesor</label>
						<input type="text" name="id_usuario" class="form-control" value="<?= $row['id_usuario']?>"required>
					</div>	
                    <div class="form-group">
						<label>Archivo PDF</label>
						<input type="file" name="archivo" class="form-control" value="<?= $row['archivo']?>"required>
					</div>	
                    <div class="form-group">
						<label>Periodo escolar</label>
						<input type="text" name="periodo_esc" class="form-control" value="<?= $row['periodo_esc']?>"required>
					</div>		
                    <div class="form-group">
						<label>Descripcion</label>
						<textarea name="descripcion" class="form-control" value="<?= $row['descripcion']?>"required></textarea>
					</div>			
                    <div class="form-group">
						<label>Calificacion</label>
						<input type="text" name="calificacion" class="form-control" value="<?= $row['calificacion']?>"required>
					</div>	
                    <div class="form-group">
						<label>Integrantes</label>
						<textarea type="text"name="integrantes" class="form-control" value="<?= $row['integrantes']?>"required></textarea>
					</div>				
				</div>
				<div class="modal-footer">
					<input type="button" class="btn btn-default" data-dismiss="modal" value="Cancelar">
...
<!--View Modal HTML -->
<div id="ViewProject" class="modal fade">
	<div class="modal-dialog">
		<div class="modal-content">
			<form>
				<div class="modal-header">						
