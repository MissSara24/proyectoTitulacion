                ...
                <div class="table-wrapper">
                    <div class="table-title">
                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                <tr>
                                    <td><input type="text" name="id_proyecto" value="<?= $row['id_proyecto']?>"></td>
                                    <td><input type="text" name="nombre" value="<?= $row['nombre']?>"></td>
                                    <td><input type="text" name="id_materia" value="<?= $row['id_materia']?>"></td>
                                    <td><input type="text" name="id_carrera" value="<?= $row['id_carrera']?>"></td>
                                    <td><input type="text" name="id_usuario" value="<?= $row['id_usuario']?>"></td> 
                                </tr>
                            </tbody>
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                <tr>
                                    <td><input type="file" name="archivo" value="<?= $row['archivo']?>" style="width:140px;"></td>
                                    <td><input type="text" name="periodo_esc" value="<?= $row['periodo_esc']?>"></td>
                                    <td><input type="text" name="descripcion" value="<?= $row['descripcion']?>"></td>
                                    <td><input type="text" name="calificacion" value="<?= $row['calificacion']?>"></td>
                                    <td><input type="text" name="integrantes" value="<?= $row['integrantes']?>"></td>
                                </tr>
                            </tbody>
                        </table>
                    </form>
                   <div class="m-auto w-75 mt-2 text-center">
                        <?php
                        $valor=""; 
                        $valor="<iframe class='w-100' height='500' src='data:"."pdf".";base64,".base64_encode($row['archivo'])."' frameborder='0'></iframe>";
                        echo $valor;
                        ?>
                    </div>
                </div>
