                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><input type="text" name="id_materia" value="<?= $row['id_materia']?>"disabled></td>
                                    <td><input type="text" name="id_carrera" value="<?= $row['id_carrera']?>"disabled></td>
                                    <td><input type="text" name="id_usuario" value="<?= $row['id_usuario']?>"disabled></td> 
                                </tr>
                            </tbody>
                            <thead>
                                <tr>
